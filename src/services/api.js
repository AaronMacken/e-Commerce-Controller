...
// function is ran when user has logged in
export function setTokenHeader(token) {
    // if a jwt exists, send it along in the headers with all future requests
    if(token) {
...
// Generic api Call function that can be re-used for different ajax calls
